...
router.get('/notification/notify/:userId', authUser , notificationController.getAllPublishedNotificationsByUserId)
router.get('/notification/:id' , authUser , notificationController.getNotificationById)
router.put('/notification/read/:id', authUser, notificationController.readNotificationById)
